...
#define UE_PROJECT_NAME BasicTraining
#define UE_TARGET_NAME BasicTrainingEditor
#define UE_MODULE_NAME "BasicTraining"
...
#define BASICTRAINING_API DLLEXPORT
